...
CREATE TABLE `exploracion` (
  ...
  KEY `ID_expediente_e_idx` (`ID_expediente`),
  CONSTRAINT `ID_expediente_e` FOREIGN KEY (`ID_expediente`) REFERENCES `expediente` (`ID_expediente`)
...
INSERT INTO `exploracion` VALUES (10,'Relacion canina','fiufuf',161);
